...
3. Open [this link](../../settings/actions)
...
5. Wait about 20 seconds, refresh the page, and follow the step-by-step instructions in the new repository's README.
